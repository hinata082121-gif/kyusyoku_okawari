...
const pageMeta: Record<RouteKey, { title: string; description: string }> = {
  ...
  '/strategy': {
    ...
    description: '給食おかわり争奪戦の攻略のコツ。フライングを避け、レア度やメニューごとの特徴を活かしておかわりを狙いましょう。',
  },
  '/menus': {
    title: '給食メニュー紹介｜給食おかわり争奪戦',
    description: 'カレー、揚げパン、プリン、七夕ゼリー、幻のジャンボプリンなど、レア度別の給食メニューを紹介します。',
  },
  '/series': {
  ...
  return `
    <div class="site-shell">
      ...
      <section class="hero">
        <div class="hero-copy">
          ...
          <p class="summary">
            ...
            カレー、揚げパン、プリン、七夕ゼリー、幻のジャンボプリンなど、懐かしい給食メニューを集めながら、クラスの英雄を目指しましょう。
            短時間で遊べるスマホ向けミニゲームとして、給食あるある、じゃんけんの緊張感、レアメニューのコレクション要素を楽しめます。
          </p>
      ...
      <section class="content-grid" aria-label="ゲーム概要">
        ...
        <article>
          <h2>レアメニュー</h2>
          <p>激レアや伝説メニューは出現しにくく、早く並んでもじゃんけん勝負になりやすい特別枠です。</p>
        </article>
        <article>
          <h2>給食コレクション</h2>
          <p>登場したメニューは発見済み、勝って獲得できたメニューはコレクションに登録されます。</p>
        </article>
        <article>
          <h2>SNS共有</h2>
          <p>結果画面には称号と短いコピーが出るので、スクショやショート動画素材として楽しめます。</p>
        </article>
      </section>
      ...
      <section class="result-section">
        <h2>レア度とコレクション</h2>
        <p>
          メニューには「ふつう」「ちょいレア」「レア」「激レア」「伝説」のレア度があります。
          レア度が高いほど出現しにくく、獲得も難しくなります。
          一度でも出現したメニューは発見済みになり、勝っておかわりに成功すると獲得済みとして給食コレクションに登録されます。
        </p>
      </section>
      <section class="content-grid" aria-label="登場メニュー概要">
        ...
        <article>
          <h2>七夕ゼリー</h2>
          <p>特別な日に出る激レアメニュー。出現しただけで教室がざわつく、コレクション向けの一皿です。</p>
        </article>
        <article>
          <h2>幻のジャンボプリン</h2>
          <p>伝説メニュー。出現率は低く、早く並んでも最後はじゃんけんで決まります。</p>
        </article>
        <article>
          <h2>スペシャルカレー</h2>
          <p>年に一度の伝説メニュー。勝てばリザルトでもコレクションでも大きな達成感があります。</p>
        </article>
      </section>
      <section class="result-section">
        <h2>スクショしたくなるリザルト</h2>
        <p>
          ...
          「最後のプリン、取った。」「じゃんけんで全てを失った。」「伝説メニュー、獲得。」「まだ“いただきます”前だった。」など、
          給食の小さな勝負をラスボス戦みたいに大げさに楽しめます。
          レアメニュー獲得時には「NEW COLLECTION!」や「伝説メニュー獲得！」の演出も表示されます。
        </p>
      </section>
      <section class="result-section">
        <h2>SNS投稿用の録画モード</h2>
        <p>
          ショート動画やスクショ投稿に使いやすい録画専用モードも用意しています。
          勝利パターン、敗北パターン、コレクション紹介、サムネイル用の画面をURLクエリで表示できます。
          通常プレイの導線を邪魔しない、SNS投稿素材向けの補助機能です。
        </p>
        <p>
          <a href="/?recording=win">勝利パターン</a> /
          <a href="/?recording=lose">敗北パターン</a> /
          <a href="/?recording=collection">コレクション紹介</a> /
          <a href="/?recording=thumbnail">サムネイル用</a>
        </p>
      </section>
...
function renderHowToPlay(): string {
  return `
    <ol class="steps">
      ...
      <li>押すのが早すぎるとフライングになります。</li>
      <li>遅すぎると列の後ろになり、売り切れになることがあります。</li>
      <li>残り1個なら、グー・チョキ・パーでクラスメイトとじゃんけんします。</li>
      <li>レア度が高いメニューは、早く並んでもじゃんけんになることがあります。</li>
      <li>勝てばおかわり成功。給食コレクションにも登録されます。</li>
      <li>結果画面には称号とシェア用コピーが出るので、スクショ共有にも向いています。</li>
    </ol>
    <p>フライングすると先生に止められます。合図をよく見て、人気メニューを勝ち取りましょう。</p>
    <h2>コレクションを見る</h2>
    <p>タイトル画面の「給食コレクション」から、発見済み・未獲得・獲得済みのメニューを確認できます。未発見メニューは「？？？」で表示されます。</p>
...
function renderPrivacy(): string {
  return `
    ...
    <p>制定日: 2026年5月19日 / 最終改定日: 2026年5月26日</p>
  `;
}
...
function renderStrategy(): string {
  return `
    <ul class="steps">
      ...
      <li>「おかわり開始！」が出た瞬間を狙いましょう。</li>
      <li>早く押すほど列の前に並びやすくなります。</li>
      <li>カレーはバランス型で初心者にも狙いやすいメニューです。</li>
      <li>揚げパンは早押しが重要です。</li>
      <li>プリンはじゃんけんに発展しやすい人気メニューです。</li>
      <li>激レアや伝説メニューは、早く並んでもじゃんけん勝負になりやすいです。</li>
      <li>レアメニューは出ただけでもチャンスなので、勝てばコレクション登録を狙いましょう。</li>
      <li>失敗しても、発見済みとして記録されるメニューがあります。</li>
      <li>面白いリザルトが出たらスクショ共有がおすすめです。</li>
    </ul>
    <h2>レア度システム</h2>
    <p>給食メニューにはレア度があります。レア度が高いほど出現しにくく、獲得も難しくなります。特に激レアや伝説メニューは、タイミングよく並んでもじゃんけんになることがあり、勝てば大きな達成感を味わえます。</p>
    <ul class="steps">
      <li>ふつう: 出現しやすく、初心者でも狙いやすいメニューです。</li>
      <li>ちょいレア: 少し出にくく、タイミングが重要になります。</li>
      <li>レア: 出現率が低く、じゃんけん勝負になりやすいメニューです。</li>
      <li>激レア: かなり出にくく、獲得には運とじゃんけんの勝利が必要です。</li>
      <li>伝説: ごく低確率で出現する特別メニューです。早く並んでも最後はじゃんけんで決まります。</li>
    </ul>
...
function renderMenus(): string {
  return `
    <p>給食メニューにはレア度があり、出現しやすさやじゃんけんの起きやすさが変わります。ここでは代表的なメニューをレア度別に紹介します。</p>
    <section class="menu-list">
      <article>
        <h2>カレー</h2>
        <p>レア度: ふつう / 人気度: 高 / 難易度: 普通</p>
        <p>給食の王道人気メニュー。残り数は比較的多めですが、クラス全体の注目度も高く、油断すると列の後ろに回ってしまいます。初心者にもおすすめのバランス型です。</p>
      </article>
      <article>
        <h2>わかめご飯・冷凍みかん・ゼリー</h2>
        <p>レア度: ふつう</p>
        <p>出現しやすく、給食らしい懐かしさを感じやすいメニューです。何度も遊ぶ中で、まずはこのあたりの獲得を狙うとコレクションが埋まりやすくなります。</p>
      </article>
      <article>
        <h2>揚げパン</h2>
        <p>レア度: ちょいレア / 人気度: 高 / 難易度: 高</p>
        <p>早押し勝負になりやすいメニュー。合図の直後に素早く動くことが重要で、少しの出遅れが結果に響きます。</p>
      </article>
      <article>
        <h2>からあげ・ソフト麺・コーヒー牛乳</h2>
        <p>レア度: ちょいレア</p>
        <p>出るとうれしい人気枠です。ふつうメニューより出にくく、タイミング勝負やじゃんけんの緊張感も少し上がります。</p>
      </article>
      <article>
        <h2>プリン</h2>
        <p>レア度: レア / 人気度: 最大 / じゃんけん発生: 高</p>
        <p>残り1個をめぐるじゃんけん勝負が起きやすい、争奪戦の主役級メニューです。勝っても負けても結果画面の一言が映えます。</p>
      </article>
      <article>
        <h2>ミルメーク・ココア揚げパン・フルーツポンチ</h2>
        <p>レア度: レア</p>
        <p>出現率が低く、給食の記憶に残りやすいメニューです。出たらコレクション登録のチャンスとして、少し本気で狙いたい枠です。</p>
      </article>
      <article>
        <h2>七夕ゼリー・クリスマスケーキ・卒業祝いクレープ</h2>
        <p>レア度: 激レア</p>
        <p>特別な日に出るイベント感のあるメニューです。出現しただけで教室がざわつき、獲得にはじゃんけんの勝利も重要になります。</p>
      </article>
      <article>
        <h2>幻のジャンボプリン</h2>
        <p>レア度: 伝説</p>
        <p>ごく低確率で出現する伝説メニュー。早く並んでも最後はじゃんけんで決まります。勝てばスクショしたくなる達成感があります。</p>
      </article>
      <article>
        <h2>年に一度のスペシャルカレー</h2>
        <p>レア度: 伝説</p>
        <p>いつものカレーとは違う特別枠です。クラス全員が狙うような空気を、レア度と強制じゃんけんで表現しています。</p>
      </article>
    </section>
    <h2>給食コレクション</h2>
    <p>ゲーム中に登場した給食メニューは、コレクションとして記録されます。一度でも出現したメニューは発見済みになり、勝っておかわりに成功すると獲得済みになります。</p>
    <ul class="steps">
      <li>発見済み: 一度でもゲーム中に出現したメニューです。</li>
      <li>未獲得: 出現はしたものの、まだおかわり成功していないメニューです。</li>
      <li>獲得済み: 成功または最後の1個獲得でコレクション登録されたメニューです。</li>
      <li>獲得回数: 同じメニューを何度獲得したかを記録します。</li>
      <li>NEW COLLECTION: 初めて獲得した時にリザルトで表示されます。</li>
      <li>？？？: まだ出会っていない未発見メニューです。</li>
    </ul>
    <p>まだ見ぬ給食メニューを探しながら、何度も遊んでコレクションを埋めていきましょう。伝説メニューを獲得できたら、ぜひ結果画面をスクショして共有してみてください。</p>
  `;
}
...
function renderSeries(): string {
  return `
    ...
    <p>第一弾は、先生の視界を避けながら教室へ戻る「チャイムまでに帰れ！ / RoukaDash」。第二弾は、給食のおかわりをめぐる「給食おかわり争奪戦」です。</p>
    <!-- TODO: RoukaDashの正式URLに差し替え -->
    <p>第一弾「チャイムまでに帰れ！ / RoukaDash」の公開URLは確認中です。正式URLを確認でき次第、ここから遊べる導線を追加します。</p>
